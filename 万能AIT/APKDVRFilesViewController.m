...
- (void)viewDidLoad {
    ...
    self.fileType = [[APKDVR sharedInstance].fileType isEqualToString:@"normal"] ? APKFileTypeVideo : APKFileTypeEvent;
    ...
    [self.backBtn setTitle:NSLocalizedString(typeKey, nil) forState:UIControlStateNormal];
...
-(UILabel *)titleL
{
    if (!_titleL) {
        ...
        label.text = NSLocalizedString(@"DVR", nil);
